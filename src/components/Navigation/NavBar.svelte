    ...
    <div class="flex flex-col md:flex-row px-4 font-medium items-center tracking-wide">
        ...
        <ul class="flex flex-col md:flex-row mx-auto md:mt-0 mt-2 list-disc md:list-none">
            <li class="md:mx-3 md:py-6 pb-2">
                <a class="hover:text-gray-700 focus:text-gray-700 text-gray-900" href="#"> Features </a>
            </li>
            <li class="md:mx-3 md:py-6 pb-2">
                <a class="hover:text-gray-700 focus:text-gray-700 text-gray-900" href="#"> Pricing </a>
            </li>
            <li class="md:mx-3 md:py-6 pb-2">
                <a class="hover:text-gray-700 focus:text-gray-700 text-gray-900" href="#"> FAQ </a>
            </li>
            <li class="md:mx-3 md:py-6 pb-2">
                <a class="hover:text-gray-700 focus:text-gray-700 text-gray-900" href="#"> Contact </a>
            </li>
        </ul>
        <div class="flex">
            <a
                class="md:my-4 mt-2 mr-2 md:mr-4 mb-4 px-4 py-2 hover:bg-gray-200 border-2 border-blue-600 rounded text-blue-700"
                href="#"
            >
                Sign In
            </a>
            <a
                class="md:my-4 mt-2 mb-4 px-4 py-2 bg-blue-600 hover:bg-blue-700 border-2 border-blue-600 hover:border-blue-700 rounded text-white"
                href="#"
            >
                Sign Up
            </a>
